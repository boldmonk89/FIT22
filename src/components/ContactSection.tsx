        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="flex flex-col items-start">
              <h3 className="text-base sm:text-lg font-black italic uppercase tracking-tight mb-3 border-b-2 border-black pb-0.5">
                BRANCH ADDRESSES
              </h3>
              <div className="text-xs sm:text-sm font-bold italic leading-relaxed flex flex-col gap-3">
                <a
                  href="https://maps.google.com/?q=Fit22+The+Gym+Sector+4+Gurugram"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline flex items-start gap-1.5 text-black group"
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="text-xs sm:text-sm font-bold italic leading-relaxed w-full flex flex-col gap-3">
                <a href="tel:+919962870777" className="inline-flex items-center gap-2.5 hover:underline text-black group" title="Click to call Sector 4 & Palam Vihar Arena">
                  <span className="w-6 h-6 rounded-full bg-black text-[#FFED29] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform shadow-sm">
                ...
                <a href="tel:+919555829555" className="inline-flex items-center gap-2.5 hover:underline text-black group" title="Click to call Sector 52 Arena">
                  <span className="w-6 h-6 rounded-full bg-black text-[#FFED29] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform shadow-sm">
                    <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                      <path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z"/>
                    </svg>
                ...
                <span className="text-[11px] block text-black/80 font-mono mt-1">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="text-xs sm:text-sm font-bold italic leading-relaxed w-full flex flex-col gap-2.5">
                <a href="https://instagram.com/fit22_thegym" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:underline text-black group">
                  <span className="w-5 h-5 rounded-md bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shrink-0 shadow-sm group-hover:scale-110 transition-transform">
                ...
                <a href="https://instagram.com/fit22thegym_sector4" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:underline text-black group">
                  <span className="w-5 h-5 rounded-md bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shrink-0 shadow-sm group-hover:scale-110 transition-transform">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 24 24">
                      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                    </svg>
                ...
                <span className="text-[11px] block text-black/80 font-mono mt-1">
                  Follow for daily athletic motivation
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex flex-col gap-2.5 w-full">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1ebd5a] text-white font-black uppercase text-xs px-3.5 py-2 rounded-full shadow-md transition-all group/wa w-full justify-start"
                >
                  <span className="w-5 h-5 rounded-full bg-white text-[#25D366] flex items-center justify-center shrink-0 shadow-sm group-hover/wa:scale-110 transition-transform">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 24 24">
                ...
                >
                  ...
                  <span>PALAM VIHAR ARENA</span>
                </a>

                <div className="inline-flex items-center gap-1.5 text-[11px] font-bold italic mt-1 text-black">
          ...
          <div className="mt-8 pt-4 border-t border-black/20 flex flex-col sm:flex-row items-center justify-between text-[11px] font-black italic uppercase tracking-wider">
            <span>© {new Date().getFullYear()} FIT22 THE GYM. ALL RIGHTS RESERVED.</span>
            <span>GURUGRAM&apos;S PREMIER ATHLETIC SANCTUARIES</span>
          </div>
